...
class _ScanDocumentScreenState extends State<ScanDocumentScreen>
        ...
        child: ListView(
          ...
          children: [
            Text(
              ...
              style: TextStyle(fontSize: 14.w(context), color: color51708E),
            ),
  ...
  Widget _recomendationItem(
    ...
    return Row(
      children: [
        Image(width: 35.w(context), image: AssetImage(iconPath)),
        SizedBox(width: 33.w(context)),
        Expanded(
          child: Text(
            title,
            style: TextStyle(fontSize: 14.w(context), color: color07355E),
          ),
        ),
      ],
    );
