...
import 'package:banca_movil_comercial/src/screens/products/widgets/confirm_transfer_content.dart';
            ...
            builder: (context, state) {
              if (state.destinationProduct != null) {
                return ProductCardWidget(
                  ...
                  balance:
                      num.parse(
                        state.destinationProduct?.available ?? '0',
                      ).priceFormat,
                                  ...
                                  child: ConfirmTransferContent(
                                    ...
                                    onEnviar: () async {
                                      try {
                                        ...
                                        context.pop();
                                        showFailTransferDialog(context);
                                      }
                                    },
                                  ),
                                ),
