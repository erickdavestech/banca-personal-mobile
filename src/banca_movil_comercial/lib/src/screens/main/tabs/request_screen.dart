...
class _RequestScreenState extends State<RequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          text.requestTitle,
          style: TextStyle(fontSize: 19.w(context)),
        ),
      ...
      //                     horizontal: 128.w(context),
      //                   ),
      //                   child: Column(
      //                     mainAxisAlignment: MainAxisAlignment.center,
      //                     children: [
      //                       Image(image: AssetImage(AppImages.noRequest)),
      ...
      //                   children:
      //                       filteredSolicitudes
      //                           .map((item) => _solicitudCard(item, text))
      //                           .toList(),
      //                 ),
      //       ),
      //       Padding(
      ...
      //           onPressed: () {},
      //           style: ElevatedButton.styleFrom(backgroundColor: color043371),
      //           child: Text(
      //             text.buttonRequest,
      //             style: TextStyle(
      //               fontSize: 16,
  ...
  //     decoration: BoxDecoration(
  //       color: isSelected ? color043371 : Colors.white,
  ...
  //         ),
  //       ],
  //       border: Border(left: BorderSide(color: item.colorRequest, width: 6)),
  ...
  //                 children: [
  //                   Text(
  //                     text.requestCardItemNumberRequest,
  ...
  //                 child: Text(
  //                   item.status,
  //                   style: TextStyle(color: item.colorStatusTitle),
  //                 ),
  //               ),
  //             ],
  //           ),
