...
//   factory RetenidosYDiferidos.fromJson(Map<String, dynamic> json) =>
//       RetenidosYDiferidos(
//         numeroCuenta: json["NumeroCuenta"],
//         diferidos:
//             List<Ido>.from(json["Diferidos"].map((x) => Ido.fromJson(x))),
//         retenidos:
//             List<Ido>.from(json["Retenidos"].map((x) => Ido.fromJson(x))),
...
// final subTipoValues = EnumValues({"": SubTipo.EMPTY, "H": SubTipo.H});

// enum Tipo { DIFERIDO, RETENIDO }

// final tipoValues =
//     EnumValues({"Diferido": Tipo.DIFERIDO, "Retenido": Tipo.RETENIDO});
