...
import 'package:ca_mobile/src/screens/products/widgets/confirm_transfer_interbank.dart';
...
class _InterbankScreenState extends State<InterbankScreen> {
  ...
  if (bloc.state.beneficiarios.isEmpty) {
    bloc.add(InitBeneficiario());
  }
    super.initState();
  }
    ...
    return Form(
      ...
      child: ListView(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: (isSourceSelected && isBeneficiarySelected)
                ? () {
            ...
            style: ElevatedButton.styleFrom(
              ...
              backgroundColor: color005199, // color activo
      ...
      return AlertDialog(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
             text.interbankTransferAlertTitle,
        ...
        content: Text(
          text.interbankTransferAlertSubTitle,
          style: TextStyle(
            fontSize: 16.w(context),
            color: color07355E,
          ),
  ...
  Widget _buildOption(String label) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color: color07355E.withAlpha(26),
            width: 2,
          ),
        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              color: isSelected ? color005199 : color506578,
              size: 20,
            ),
