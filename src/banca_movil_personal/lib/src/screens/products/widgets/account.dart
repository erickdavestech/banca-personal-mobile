...
import 'package:ca_mobile/src/screens/products/widgets/modal_card_data.dart';
...
class Account extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final card = product.associatedDebitCards
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: card?.firstOrNull == null ? color1370C2 : color005199,
              borderRadius: BorderRadius.circular(24),
            ),
            child: Stack(
              children: [
