...
class ProductsTransferScreen extends StatelessWidget {
            ...
            child: BlocBuilder<ProductsBloc, ProductsState>(
              builder: (context, state) {
                if (state is ProductsLoaded) {
                  return ListView(
                    children: state.products.account.products
                        .map((cuenta) =>
                            _productCard(context, cuenta, isOriginProduct))
                        .toList(),
                  );
                }
                return Center(
  ...
  Widget _productCard(
      BuildContext context, Product cuenta, bool isOriginProduct) {
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  context
                      ...
                      .add(ProductSelectedEvent(cuenta));
                },
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image(
                        ...
                        width: 37.w(context),
                        height: 36.h(context),
                        color: productDisabled?.id == cuenta.id
                            ? color506578
                            : null,
                      ),
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${cuenta.description}",
                              style: TextStyle(
                                  fontSize: 12.h(context), color: color506578),
                            ),
                          ],
                        ),
                      ),
